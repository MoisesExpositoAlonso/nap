...
if(type=='bslmm'){
  command= paste0('~/bin/gemma -bfile ', file.path(plinkfolder, plinkbase) ,'  -bslmm ')
}else if(type=='lm'){
  command= paste0(' ~/bin/gemma -bfile ', file.path(plinkfolder, plinkbase) ,'  -lm 4  ')
}else if(type=='lmm'){
  command0= paste0(' ~/bin/gemma -bfile ', file.path(plinkfolder, plinkbase) ,'  -gk 1  -o ' ,out)
  command= paste0(' ~/bin/gemma -bfile ', file.path(plinkfolder, plinkbase) ,'  -k ', paste0(out,'.cXX.txt') , '  -lmm 4 ')
}
