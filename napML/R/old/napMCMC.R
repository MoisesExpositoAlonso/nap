################################################################################
#### DEPRECATED April 18 2019####
################################################################################

# nap <- function(y, h, A, m, n, s, b = 0.1, bmin = 0, bmax = 1, a = 0.1, amin = 0, amax = 1, p = 0.1, pmin = 0, pmax = 1, mu = 1, mumin = 0, mumax = 50, epi = 1, epimin = 1, epimax = 1, svar = 0.1, svarmin = 0.001, svarmax = 1, ss = 0.1, ssmin = 0, ssmax = 1, smin = -0.98039215686274505668, smax = 10, iterations = 1e4L, burnin = 0.1, Smode = 2L, LIKmode = 2L, PRImode = 1L, FITmode = 2L, verbose = FALSE, test = FALSE, updateratio = -9.0, bw = 0.001, file2sink = "output.log", sink2file = FALSE) {
