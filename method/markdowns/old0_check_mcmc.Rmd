...
```{r}
message("update one snp")

s=PropoS(10)
s2=test_UPDATES(s)
qplot(x=s,s2,xlab="Proposal of S", ylab="Updated S")
...
y=test_PRIORR()
qplot(y, x=1:4, xlab='Prior modes', ylab="Log Probability") +
  scale_x_continuous(breaks=c(1:4),labels=c("improper","uniform","lognormal","lognormal sparse") )
